...
public interface BanqueWS {
    ...
    @RequestWrapper(localName = "conversionDollarToOugiya", targetNamespace = "http://service/", className = "service.ConversionDollarToOugiya")
    @ResponseWrapper(localName = "conversionDollarToOugiyaResponse", targetNamespace = "http://service/", className = "service.ConversionDollarToOugiyaResponse")
    @Action(input = "http://service/BanqueWS/conversionDollarToOugiyaRequest", output = "http://service/BanqueWS/conversionDollarToOugiyaResponse")
    public double conversionDollarToOugiya(
